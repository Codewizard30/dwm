...
df = pd.read_excel(r'C:\Users\shrad\OneDrive\Desktop\dwm final codes\KMeans2D.xlsx')
data = df.values.tolist()  # Each row is a [x, y] point
data = [tuple(point) for point in data]  # Convert to tuples
...
# Step 6: Update centroids as mean of each cluster
...
# Step 7: Check if centroids are unchanged
